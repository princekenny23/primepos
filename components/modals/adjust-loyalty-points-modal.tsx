...
export function AdjustLoyaltyPointsModal({ open, onOpenChange, customer }: AdjustLoyaltyPointsModalProps) {
      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-4">
          <div className="p-3 bg-muted rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">Tier: {customer.tier}</p>
          </div>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isProcessing || !points || parseInt(points) <= 0 || (adjustmentType === "subtract" && parseInt(points) > currentPoints)}
          >
            {isProcessing ? "Processing..." : `Apply ${adjustmentType === "add" ? "Addition" : adjustmentType === "subtract" ? "Subtraction" : "Set"}`}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
