...
const productsFields: DataField[] = [
  ...
  },
  {
    ...
    required: false,
    example: "Size Small",
    description: "Product variation/size",
  },
  {
    name: "unit",
    label: "Unit",
  ...
  },
  {
    ...
    required: false,
    example: "12",
    description: "Convert to base unit",
  },
]
...
export const dataExchangeConfigs: Record<string, DataExchangeConfig> = {
  products: {
    ...
    apiEndpoints: {
      import: "/api/v1/products/bulk-import/",
      export: "/api/v1/products/bulk-export/",
    },
  },
  reports: {
    entityType: "reports",
