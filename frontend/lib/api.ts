    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (!errorMessage && typeof errorData === 'object') {
          ...
          const fieldErrors = ['email', 'password', 'name', 'phone', 'role', 'outlet_ids', 'outlet_id', 'product_id', 'outlet', 'movement_type', 'quantity', 'product', 'reason']
...
export const apiEndpoints = {
  ...
  imports: {
    ...
    productsCancel: (batchId: string) => `/imports/products/${batchId}/cancel/`,
    productsRecover: (batchId: string) => `/imports/products/${batchId}/recover/`,
    productsRollbackPreview: (batchId: string) => `/imports/products/${batchId}/rollback-preview/`,
    productsRollback: (batchId: string) => `/imports/products/${batchId}/rollback/`,
