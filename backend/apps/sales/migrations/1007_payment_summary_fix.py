...
def apply_payment_summary_fix(apps, schema_editor):
    ...
    with schema_editor.connection.cursor() as cursor:
        ...
        cursor.execute("DROP MATERIALIZED VIEW IF EXISTS sales_payment_daily_summary;")
...
def rollback_payment_summary_fix(apps, schema_editor):
    if schema_editor.connection.vendor != "postgresql":
        return
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sales', '1006_merge_20260208_1136'),
    ]

    operations = [
        migrations.RunPython(apply_payment_summary_fix, reverse_code=rollback_payment_summary_fix),
    ]